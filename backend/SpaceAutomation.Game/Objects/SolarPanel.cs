...
{
    [Observed("enabled")] public bool Enabled { get; set; } = true;
    [Observed("source")] public EnergySource Source { get; set; } = new();
    [Observed("energy_per_tick", Persist = false)] public double EnergyPerTick => Source.ProductionPerTick;
    [Observed("energy_generated", Persist = false)] public double EnergyGenerated => Source.EnergyGenerated;
...
{
    public PortableSolarPanel() { Source.ProductionPerTick = 0.2; }
}
