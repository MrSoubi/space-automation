...
{
    [Observed("capacity")] public double Capacity { get; set; } = 20;
    [Observed("charge")] public double Charge { get; set; } = 20;
...
{
    [Observed("production_per_tick")] public double ProductionPerTick { get; set; } = 1;
    [Observed("energy_generated")] public double EnergyGenerated { get; set; }
...
{
    [Observed("demand")] public double Demand { get; set; }
    [Observed("received")] public double Received { get; set; }
...
public interface IProducer { EnergySource Source { get; } bool Enabled { get; } }
public interface IConsumer { EnergyConsumer Consumer { get; } }
public interface IStorage { EnergyStorage Storage { get; } }
...
public interface IEnergyNode { string Id { get; } EnergyPort Energy { get; } }
// Mobile nodes cannot tether to a grid while a move is pending.
public interface IMobile { bool HasPendingMovement { get; } }
// Hosts carry installed components; their wiring is checked once the whole world exists.
public interface IComponentHost { void ValidateComponents(); }
